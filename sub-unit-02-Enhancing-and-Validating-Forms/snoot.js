...
function updateDays() {
    ...
    var selectedMonth = deliveryMonth.options[deliveryDay.selectedIndex].value;
    while (dates[28]) {
...
function validateAddress(fieldsetId) {
    ...
    try {
        LOG("I am executing the try clause");
    } catch (msg) {
...
function validatePayment() {
    var selectElements = document.querySelectorA("#deliveryDate select");
    var errorDiv = document.querySelect("#deliveryDate.errorMessage");
    var fieldsetValidity = true;
    var elementCount = selectElements.length;
    var currentElement;
